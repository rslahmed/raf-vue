...
<template>
    ...
    <div class="container py-4 flex justify-between">
        <div class="flex gap-3 items-center">
            ...
            <RouterLink to="/" class="text-gray-600 font-medium hover:text-primary">Shop</RouterLink>
            <span class="text-sm text-gray-400">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                     stroke="currentColor" class="w-4 h-4">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5"/>
            ...
            <p class="text-gray-600 font-medium">Office</p>
        </div>
    </div>
    <!-- breadcrumbs end -->

    <div class="container pb-6 grid lg:grid-cols-2 gap-6">
        <!-- product image -->
        <div>
            <div>
                <img id="main-img" alt src="/images/products/product9.jpg" class="w-full">
            </div>
            <div class="grid grid-cols-5 gap-4 mt-4">
                <div>
                    <img alt src="/images/products/product9.jpg"
                         class="single-img w-full cursor-pointer border border-primary">
                </div>
                <div>
                    <img alt src="/images/products/product1.jpg" class="single-img w-full cursor-pointer border">
                </div>
                <div>
                    <img alt src="/images/products/product8.jpg" class="single-img w-full cursor-pointer border">
                </div>
                <div>
                    <img alt src="/images/products/product12.jpg" class="single-img w-full cursor-pointer border">
                </div>
                <div>
                    <img alt src="/images/products/product11.jpg" class="single-img w-full cursor-pointer border">
                </div>
            </div>
        </div>
        <!-- product image end -->
        ...
        <div>
            ...
            <div class="flex items-center mb-4">
                <div class="flex gap-1 text-sm text-yellow-400">
                    <svg v-for="n in 5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                         class="w-4 h-4">
