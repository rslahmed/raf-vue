                ...
                <RouterLink to="/" class="text-primary">
                    <svg width="17" height="17" viewBox="0 0 32 32">
                        <path fill="currentColor"
                              d="m16 2.594l-.719.687l-13 13L3.72 17.72L5 16.437V28h9V18h4v10h9V16.437l1.281 1.282l1.438-1.438l-13-13zm0 2.844l9 9V26h-5V16h-8v10H7V14.437z"></path>
                    </svg>
                </RouterLink>
  ...
  <!-- contact form -->
    <div class="container py-14">
        <div class="grid grid-cols-12 gap-6">
            <div class="col-span-12 lg:col-span-7 bg-white shadow-md px-[30px] py-[24px]">
                <div>
                    ...
                    <div class="grid grid-cols-12 gap-5">
                        <div class="col-span-12 sm:col-span-6">
                            <div>
                                <label for="first_name" class="block mb-1.5">First Name <span
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            <div class="single_billing_inp">
                                <label for="last_name" class="block mb-1.5">Last Name <span
                                        class="text-[#fd3d57ad]">*</span></label>
                                <input type="text"
                                       class="w-full border border-[#E9E4E4] rounded focus:border-[#fd3d57ad] focus:ring-0">
                            </div>
                        ...
                        <div class="col-span-12">
                            <div class="single_billing_inp">
                                <label for="email_addr" class="block mb-1.5">Email Address <span
                                        class="text-[#fd3d57ad]">*</span></label>
                                <input type="text"
                                       class="w-full border border-[#E9E4E4] rounded focus:border-[#fd3d57ad] focus:ring-0">
                            </div>
                        ...
                        <div class="col-span-12">
                            <div class="single_billing_inp">
                                <label for="county_region" class="block mb-1.5">Your message <span
                                        class="text-[#fd3d57ad]">*</span></label>
                                <textarea type="text"
            ...
            <div class="col-span-12 lg:col-span-5 bg-white shadow-md px-[30px] py-[24px]">
                <div class=" padding_default border-0 shadow_sm">
                    ...
                    <p class="text_md mb-0">If you are interesting in emplyment <br> opportunities at RAFCARTs. Please
                        email us :
                    </p>
